    ...
    public void pickRandomWords() {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(GuessCountryActivity.this, R.string.Well_done, Toast.LENGTH_SHORT).show();
                    correct1++;
                } else {
                    Toast.makeText(GuessCountryActivity.this, R.string.Bad_done, Toast.LENGTH_SHORT).show();
                    wrong1++;
                }
                pickRandomWords();
            }
