...
public class GuessCapitalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartAppSDK.init(this, "201337339", false);
        setContentView(R.layout.activity_guess_capital);
    ...
    public void pickRandomWords() {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(GuessCapitalActivity.this, R.string.Well_done, Toast.LENGTH_SHORT).show();
                    correct1++;
                } else {
                    Toast.makeText(GuessCapitalActivity.this, R.string.Bad_done, Toast.LENGTH_SHORT).show();
                    wrong1++;
                }
                pickRandomWords();
            }
